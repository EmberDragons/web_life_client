...
export const SERVER_ADRESS = 'https://f671-2a02-8428-37af-b01-9152-2269-5f2a-3273.ngrok-free.app';
...
function setProfileFriend() {
    ...
    removeBtn.className = "profile_other_button_remove";
    removeBtn.onclick = remove_friend;

    const removeImg = document.createElement("img");
    removeImg.className = "profile_other_name_image_remove";
    removeImg.src = "https://icons.hackclub.com/api/icons/red/member-remove";
